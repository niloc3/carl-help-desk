...
module.exports = {
        ...
        async execute(interaction, client, Discord, mixpanel) {
            ...
            if (interaction.componentType == 'BUTTON') {
                if (interaction.customId == 'start') {
                ...
                } else if (interaction.customId == 'modalYes') {
                ...
                } else if (interaction.customId == 'modalNo') {
                    const modal = new Modal()
                        .setCustomId('No')
                        .setTitle('Give us Some Feedback')
                        .addComponents(
                    ...
                    const feedbackButtons = new MessageActionRow()
                        .addComponents(
                            new MessageButton()
                    ...
                    const feedbackYesRow = new MessageActionRow()
                        .addComponents(
                            new MessageButton()
                            .setCustomId('modalYes')
                            .setStyle('SECONDARY')
                    ...
                    interaction.update({
                        ...
                        content: 'Glad I could help! Feel free to give additional feedback below. If not, just press submit.',
                        ephemeral: true
                    })

                } else if (interaction.customId == 'feedbackNo') {
                    const feedbackNoRow = new MessageActionRow()
                        .addComponents(
                            new MessageButton()
                            .setCustomId('modalNo')
                            .setStyle('SECONDARY')
                    ...
                    interaction.update({
                        ...
                        content: 'Sorry I couldn\'t help! Please ask in another support channel and a human will help you out. Feel free to give additional feedback below. If not, just press submit.',
                        ephemeral: true
                    })
                } else if (interaction.customId == 'submitNo') {
                    const submitNoEmbed = new MessageEmbed()
